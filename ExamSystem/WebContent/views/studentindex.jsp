        ...
        <ul class="nav navbar-nav pull-right">
          <li class="dropdown pull-right">            
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
              <i class="icon-user"></i> 考生：${user.name} <b class="caret"></b>              
            </a>
...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li class="has_sub"><a href="#"><i class="icon-user"></i> 信息管理 <span class="pull-right"><i class="icon-chevron-right"></i></span></a>
            <ul>
              <li><a href="#" onclick="menuClick('${base}toStudentManager')"><i class="glyphicon glyphicon-th-list"></i>个人资料管理</a></li>
            </ul>
          </li>  
          <li class="has_sub"><a href="#"><i class="icon-search"></i> 考试系统  <span class="pull-right"><i class="icon-chevron-right"></i></span></a>
            <ul>
              <%-- <li><a href="#" onclick="menuClick('${base}toStudentExam')"><i class="glyphicon glyphicon-th-list"></i>考试</a></li> --%>
              <li><a href="#" onclick="menuClick('${base}toExamGroup')"><i class="glyphicon glyphicon-th-list"></i>考试列表</a></li>
            </ul>
          </li>  
          <li><a href="#" onclick="menuClick('${base}toStudentScore')"><i class="icon-tasks"></i>成绩查询</a></li>                           
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
	   ...
	   <div>
				<iframe id="iframe-page-content" src="../jsp/myindex.jsp" width="100%"  frameborder="yes" border="0" marginwidth="0" marginheight="0" scrolling="auto" ></iframe>
			</div>				
		</div><!-- /.main-content -->
</div><!-- /.main-container -->
