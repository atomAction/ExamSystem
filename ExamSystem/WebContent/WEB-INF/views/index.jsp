        ...
        <ul class="nav navbar-nav pull-right">
          <li class="dropdown pull-right">            
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
              <i class="icon-user"></i> 欢迎你：${user.name}<b class="caret"></b>              
            </a>
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li class="has_sub"><a href="#"><i class="icon-user"></i> 信息管理 <span class="pull-right"><i class="icon-chevron-right"></i></span></a>
            <ul>
			  <li><a href="#" onclick="menuClick('${base}toTeacherManager')"><i class="glyphicon glyphicon-th-list"></i>个人资料管理</a></li>
          ...
          <li class="has_sub"><a href="#"><i class="icon-search"></i> 考试系统  <span class="pull-right"><i class="icon-chevron-right"></i></span></a>
            <ul>
              <li><a href="#" onclick="menuClick('${base}toTeacherExamGroup')"><i class="glyphicon glyphicon-th-list"></i>考试列表</a></li>
            </ul>
          </li>  
         <li><a href="#" onclick="menuClick('${base}tostudentExamListForTeacher')"><i class="icon-tasks"></i>批改</a></li>                         
        </ul>
    </div>
